output "parameters_ids" {
  ...
  value       = { for k, v in merge(aws_ssm_parameter.this, aws_ssm_parameter.parsed, aws_ssm_parameter.unlocked) : k => v["id"] }
}

output "parameters_arns" {
  description = "parameters arns map"
  value       = { for k, v in merge(aws_ssm_parameter.this, aws_ssm_parameter.parsed, aws_ssm_parameter.unlocked) : k => v["arn"] }
}
